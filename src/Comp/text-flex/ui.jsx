    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor={"var(--yellow-700)"} />
              <stop offset="25%" stopColor={"var(--red-700)"} />
              <stop offset="50%" stopColor={"var(--blue-700)"} />
              <stop offset="75%" stopColor={"var(--cyan-700)"} />
